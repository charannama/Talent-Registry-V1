...
public class GrantPerms {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            stmt.executeUpdate("INSERT INTO permissions (id, code, description, created_at, updated_at, version, is_deleted) " +
                               "SELECT gen_random_uuid(), 'APPLICATION_UPDATE', 'Can update applications', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, false " +
