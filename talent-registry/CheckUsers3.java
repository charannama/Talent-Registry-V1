...
public class CheckUsers3 {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String sql = "SELECT email, status, password_hash, lockout_until, is_deleted FROM users WHERE email IN ('hr-admin@example.com', 'corp@myenterprise.com')";
