...
for filename in os.listdir(directory):
    ...
    # Split comma-separated ADD CONSTRAINT
    ...
    if len(parts) > 1:
        ...
        for i in range(1, len(parts), 2):
            ...
            if re.search(r',\s*ADD\s+CONSTRAINT', stmt_body, re.IGNORECASE):
                sub_stmts = re.split(r',\s*(?=\bADD\s+CONSTRAINT\b)', stmt_body, flags=re.IGNORECASE)
