...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Response object containing enterprise reactivation details")
public class ReactivateEnterpriseResponse {
    ...
    @Schema(description = "Timestamp when the enterprise was reactivated", example = "2026-06-17T12:00:00Z")
    private Instant reactivatedAt;

    @Schema(description = "ID of the HR user who reactivated the account", example = "11223344-5566-7788-99aa-bbccddeeff00")
    private UUID reactivatedBy;

    @Schema(description = "Success message", example = "Enterprise successfully reactivated")
