...
ADD CONSTRAINT fk_ent_acc_rejected_by FOREIGN KEY (rejected_by) REFERENCES users(id),
ADD CONSTRAINT fk_ent_acc_suspended_by FOREIGN KEY (suspended_by) REFERENCES users(id),
ADD CONSTRAINT fk_ent_acc_reactivated_by FOREIGN KEY (reactivated_by) REFERENCES users(id);
