...
ALTER TABLE student_profiles ADD COLUMN is_deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE student_profiles ADD COLUMN deleted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE student_profiles ADD COLUMN deleted_by VARCHAR(255);

-- 2. Fix missing base entity fields for student_skills
ALTER TABLE student_skills
ADD COLUMN version BIGINT NOT NULL DEFAULT 0;
ALTER TABLE student_skills ADD COLUMN is_deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE student_skills ADD COLUMN deleted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE student_skills ADD COLUMN deleted_by VARCHAR(255);

ALTER TABLE student_profiles ALTER COLUMN created_by TYPE VARCHAR(255);
ALTER TABLE student_profiles ALTER COLUMN updated_by TYPE VARCHAR(255);

ALTER TABLE student_skills ALTER COLUMN created_by TYPE VARCHAR(255);
